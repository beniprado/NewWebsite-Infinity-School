    ...
    <footer className="flex flex-col justify-center pb-5 pt-10 gap-5 bg-[#1A1A1A]">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-2">
              <input
                ...
                id=""
                placeholder="Email"
                className="border w-[60%] py-2 px-2 rounded-2 focus-visible:outline-none rounded-md"
              />
              <input
                type="submit"
                value="Enviar"
                className="py-2 px-4 rounded-lg cursor-pointer font-medium hover:bg-white hover:text-black border transition duration-120"
              />
            </div>
            <p className="max-w-xl text-sm">
              Ao assinar, você concorda com nossa{" "}
              <a href="/privacidade" className="font-bold underline">
                Políticas de Privacidade
              </a>{" "}
              e fornece consentimento para receber atualizações de nossa
              empresa.
            </p>
          </div>
        </div>
            ...
            <ul className={styleList}>
              ...
              >
                <li className="flex items-center gap-2">
                  <IconBrandYoutube stroke={2} /> Youtube
                </li>
              </a>
              <a
              ...
              >
                <li className="flex items-center gap-2">
                  <IconBrandInstagram stroke={2} /> Instagram
                </li>
              </a>
              <a
              ...
              >
                <li className="flex items-center gap-2">
                  <IconBrandLinkedin stroke={2} /> Linkedin
                </li>
              </a>
            </ul>
          </div>
      ...
      <div>
        <div className="flex flex-col items-baseline sm:flex-row justify-between sm:items-center max-w-7xl m-auto px-3 gap-2">
          <p>
            © 2025 Infinity. Todos seus direitos reservados. Feito por{" "}
            <a
              href="https://www.momple.com.br/"
              className="font-bold"
              target="_blank"
            >
              Momple
