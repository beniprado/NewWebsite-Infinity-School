...
const Footer = () => {
  return (
    <footer className="flex flex-col justify-center pb-5 pt-10 gap-5">
      <div className="flex-col lg:flex-row flex gap-20 justify-center py-10 px-10 border-b-1 border-b-white">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-xl text-lg">Ao assinar, você concorda com nossa <Link>Políticas de Privacidade</Link>  e fornece consentimento para receber atualizações de nossa empresa.</p>
          </div>
        </div>
      ...
      <div className="flex flex-col justifiy-center items-center gap-2 m-auto">
        <p>
