...
const Cta = () => {
    return <section className="py-35 px-5 md:px-10">
        <div className="flex flex-col items-center justify-center gap-8">
            <div className="flex items-center flex-col gap-8">
                <h2 className="text-center max-w-4xl font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Do zero ao profissional: Seu próximo passo é aqui</h2>
