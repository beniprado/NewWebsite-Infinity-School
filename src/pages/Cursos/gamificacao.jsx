...
export default function Gamificacao() {
  return (
    <section className="w-full flex flex-col items-center justify-center px-4 py-12 text-white">
      <div className="w-full max-w-6xl bg-transparent backdrop-blur-xl rounded-2xl p-6 md:p-8 shadow-2xl">
        ...
        <div className="flex flex-col gap-5 items-center justify-center text-center mt-12 px-2">
          <div>
...
function CardAluno({ aluno }) {
  return (
    <div className="flex flex-col items-center bg-gray-800/70 rounded-2xl p-6 shadow-md hover:shadow-xl transition w-full max-w-xs">
      ...
      <h3 className="text-lg font-semibold text-center">{aluno.nome}</h3>
      <p className="text-sm text-gray-400 text-center">{aluno.curso}</p>
